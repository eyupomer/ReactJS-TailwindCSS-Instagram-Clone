        ...
        <div className="w-[350px] grid gap-y-3">
          <div className="bg-white border px-[40px] pt-12">
            ...
            <form className="grid gap-y-2">
              ...
              <div>
                <a
                  className="flex justify-center items-center gap-x-2 text-sm font-semibold text-[#385185]"
                  href="/"
                >
                ...
                <a
                  className="mt-4 text-xs flex items-center justify-center text-link text-[#00376b]"
                  href="/"
                >
                  Şifremi mi unuttun?
                </a>
          ...
          <div className="bg-white border p-4 text-sm text-center">
            Hesabın yok mu?{" "}
            <a className="text-[#0095f6] font-semibold" href="/">
              Kaydol
            </a>
          </div>
